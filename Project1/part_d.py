...
from package.LinearRegression import RidgeModel
...
bp = Bootstrap(CreateData(degree=5, nr_samples=100),
               RidgeModel(), n_boostraps=100, seed=10,
               function_of="lambda")
...
bp = Bootstrap(CreateData(degree=5), RidgeModel(lambda_=1),
...
bp = Bootstrap(CreateData(nr_samples=100), RidgeModel(lambda_=1),
               n_boostraps=100, seed=10,
...
bt = BootstrapMLextend(
    CreateData=CreateData(nr_samples=100), ML_Model=Ridge(alpha=1),
